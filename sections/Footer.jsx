const fStyles = {
  section: { padding: '72px 24px 28px', background: 'var(--night)' },
  ...
  tagline: { fontFamily: 'var(--font-body)', fontSize: 14, color: 'var(--on-night-2)', maxWidth: 260, lineHeight: 1.5, margin: 0 },
  colTitle: { fontFamily: 'var(--font-mono)', fontWeight: 600, fontSize: 12, letterSpacing: 'var(--tracking-wide)', textTransform: 'uppercase', color: 'var(--lime)', marginBottom: 16 },
  link: { display: 'block', fontFamily: 'var(--font-body)', fontSize: 14.5, color: 'var(--on-night-2)', textDecoration: 'none', marginBottom: 10 },
  bottom: { display: 'flex', justifyContent: 'space-between', paddingTop: 24, borderTop: '1px solid var(--hairline-night)', fontFamily: 'var(--font-mono)', fontSize: 12.5, color: 'var(--on-night-3)', flexWrap: 'wrap', gap: 12 },
};
function Footer() {
  return (
    <footer style={fStyles.section}>
      <style>{`.mb-flink:hover{color:var(--lime)!important}`}</style>
      <div style={fStyles.inner}>
        <div className="mb-grid-4" style={fStyles.top}>
          ...
          <div>
            ...
            <a href="#" className="mb-flink" style={fStyles.link}>LinkedIn</a>
            <a href="#" className="mb-flink" style={fStyles.link}>Instagram</a>
          </div>
          <div>
